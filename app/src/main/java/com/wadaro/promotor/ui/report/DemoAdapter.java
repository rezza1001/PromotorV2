...
public class DemoAdapter extends RecyclerView.Adapter<DemoAdapter.AdapterView> {
    ...
    public AdapterView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_demo_adapter, parent, false);
    ...
    static class AdapterView extends RecyclerView.ViewHolder{
        private TextView txvw_demo_00, txvw_time_00,txvw_coordinator_00,txvw_address_00, txvw_status_00;
